...
def deploy_storage():
    ...
    print(f"some_bool is {fws._storage.some_bool.get()}")
    print(f"my_fixed_array[0] is {fws._storage.my_fixed_array.get()}")
    print(f"my_dyn_array[0] is {fws._storage.my_dyn_array.get()}")
    print(f"my_map[0] is {fws._storage.my_map.get()}")
